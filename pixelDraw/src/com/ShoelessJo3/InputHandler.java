package com.ShoelessJo3;//package io.nickw.game;
import java.awt.*;
...
import static com.ShoelessJo3.Game.scale;
import static com.ShoelessJo3.Game.screenLoc;
...
public class InputHandler implements KeyListener {
    ...
    public void mouseLoc(){
        ...
        //System.out.println(screenLoc.x);
        mouseX = (int) (b.getX() - screenLoc.x)/scale;
        mouseY = (int) (b.getY()- screenLoc.y - 36)/scale; //-36 for bannerheight
